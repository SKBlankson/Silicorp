            ...
            <div class="row">
                <div class="col-lg-6 col-xxl-12">
                    <div class="card">
                        <div class="card-body">
                            <form class="row g-3">
                                <div class="col-12"><label class="form-label form-label" for="inputNanme4">Fabricator ID</label><input class="form-control form-control" type="text" id="inputNanme-1"></div>
                                <div class="col-12"><label class="form-label form-label" for="inputNanme4">&nbsp;Fabricator Name</label><input class="form-control form-control" type="text" id="inputNanme-9"></div>
                                <div class="col-12"><label class="form-label form-label" for="inputNanme4">Location ID</label><input class="form-control form-control" type="text" id="inputNanme-2"></div>
                                <div class="col-12"><label class="form-label form-label" for="inputNanme4">Email</label><input class="form-control form-control" type="text" id="inputNanme-3"></div>
                                <div class="col-12"><label class="form-label form-label" for="inputNanme4">Telephone</label><input class="form-control form-control" type="text" id="inputNanme-5"></div>
                                <div class="text-center"><button class="btn btn-primary" type="submit">Submit</button><button class="btn btn-secondary" type="reset">Reset</button></div>
                            </form>
                        </div>
                    </div>
                    <div class="card"></div>
