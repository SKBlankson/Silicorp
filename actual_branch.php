                ...
                <div class="col-lg-12 col-xl-12 col-xxl-12" style="max-width: 100%;">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div style="display: flex;justify-content: space-between;padding-bottom: 15pxs;"><button class="btn btn-success" type="button" style="margin-right: -1px;" ><a href="#" style="color: white" onclick="openFormPopup()">
+Add Record</a></button>
<!-- <a href="form_branch.php" style="color: white"> -->
                                <button class="btn btn-primary" type="button" align="right" style="margin-right: 0px;margin-left: 0px;">Display Graph</button></div>
                            <div>
...
<!--                                            <th scope="col">   </th>-->
        ...
        <?php
            ...
            foreach ($results as $row) {
                ...
                $tableBody .= "<td align='right'><button type='button' class='btn btn-danger' onclick='confirmdelete()'><i class='bi bi-exclamation-octagon'></i></button>   <button type='button' class='btn btn-info' onclick='update()'><i class='bi bi-info-circle'></i></button></td>";
...
document.getElementById("branchtable").innerHTML = "<?php echo $tableBody?>";
function update() {
    const confirmation = confirm("Are you sure you want to update the record?");
    if (confirmation === true) {
        // Yes was clicked
        // do something
         window.open("form_branch.php", "Form Popup", "width=800,height=800");
    } else {
        // No was clicked or the modal was closed
        // do something else or nothing
    }
