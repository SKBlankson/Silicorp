            ...
            <div class="row">
                <div class="col-lg-6 col-xxl-12">
                    <div class="card">
                        <div class="card-body">
                            <form class="row g-3">
                                <div class="col-12"><label class="form-label form-label" for="inputNanme4">Integrator ID</label><input class="form-control form-control" type="text" id="inputNanme-1"></div>
                                <div class="col-12"><label class="form-label form-label" for="inputNanme4">&nbsp;Integrator Name</label><input class="form-control form-control" type="text" id="inputNanme-9"></div>
