...
create table RD_Projects(
    ...
    Mobile_Desktop BOOLEAN NOT NULL,
    MSRP float(10),
    Dept_Code varchar(10) NOT NULL,
    FOREIGN KEY (Dept_Code) REFERENCES Departments(Dept_Code) 
);
...
create table Storefront_Partners(
    Storefront_ID varchar(10) PRIMARY KEY,
...
create table CPU_Storefront_Partners(Hardware_ID varchar(10),
    ...
    FOREIGN KEY (Hardware_ID) REFERENCES RD_Projects(Hardware_ID),
    FOREIGN KEY (Storefront_ID) REFERENCES Storefront_Partners(Storefront_ID) ON DELETE CASCADE
);
...
CREATE TABLE CPU_Integrators(
    ...
    Date_contracted DATE NOT NULL,
    FOREIGN KEY (Integrator_ID) REFERENCES Integrators(Integrator_ID) ON DELETE CASCADE,
    FOREIGN KEY (Hardware_ID) REFERENCES RD_Projects(Hardware_ID) 
);
...
CREATE TABLE Fabricator_Partners(
    Fabricator_ID varchar(10) PRIMARY KEY,
...
CREATE TABLE CPU_FabricatorPartners(
    ...
    FOREIGN KEY(Hardware_ID) REFERENCES RD_Projects(Hardware_ID),
    FOREIGN KEY (Fabricator_ID) REFERENCES Fabricator_Partners(Fabricator_ID) ON DELETE CASCADE
);
...
INSERT INTO MarketingFinanceProjects(Project_ID,Dept_Code,Campaign_Name,Budget,Begin_Date,End_date)
...
-- 1 means released and Mobile and 0 means not released and Desktop
...
("CPU00016", "Intel Core i5-12600K", 18, 10, 16, 4.0, 125, 18),
...
("CPU00028", "AMD Ryzen 5 5600H", 12, 6, 12, 3.0, 35, 19),
("CPU00029", "AMD Ryzen 3 5300U", 7, 4, 8, 2.6, 15, 8),
("CPU00030", "Intel Xeon W-2295", 18, 18, 36, 3.0, 165, 24);
...
("CPU00011","INT00001", "TUF Gaming A17 FA706IU-H7015T",4200000, "2020-11-18"),
...
("GPU00003","INT00023", "Predator Triton 300 PT315-52-73WT",4699000, "2022-02-06"),
("GPU00004","INT00014", "Zephyrus G14 GA401IV-BR9N6",3599000, "2021-08-18"),
("GPU00005","INT00005", "ROG Strix G G531GT-BI7N6",2499000, "2022-01-10"),
("GPU00006","INT00016", "Pavilion Gaming 15-dk0046nr",1679000, "2021-12-05");
...
VALUES ("GPU00001", "FAB0201", "2020-01-10", 90,7600),
("GPU00002", "FAB0202", "2022-09-14",100, 2300),
("GPU00003", "FAB0203", "2021-03-27",170, 10000),
("GPU00004", "FAB0204","2022-08-11", 88, 5600),
("GPU00005", "FAB0205", "2022-08-25", 125, 4500),
("GPU00001", "FAB0201", "2021-04-08", 130, 8400),
("GPU00002", "FAB0202", "2020-11-30", 165, 12000),
("GPU00003", "FAB0203", "2021-11-27", 110, 13600),
("GPU00004", "FAB0204", "2022-10-12", 105, 2000),
("GPU00005", "FAB0205", "2022-03-17", 98, 7200);