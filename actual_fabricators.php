...
<body>
    ...
    <aside id="sidebar" class="sidebar">
        <ul class="sidebar-nav" id="sidebar-nav">
            <li class="nav-item">
                <a class="nav-link" href="index.html"><i class="bi bi-grid"></i><span>Dashboard</span></a></li>
            <li class="nav-item">
                <a class="nav-link collapsed" data-bs-target="#Data_Repository-nav" data-bs-toggle="collapse" href="tables-general.html"><i class="bi bi-card-list"></i><span>Data Repository</span>
                </a>
                <ul id="Data_Repository-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
            <li>
              <a href="actual_employees.html">
              <i class="bi bi-circle"></i><span>Employees</span>
            </a>
          </li>
          <li>
            <a href="actual_branch.html">
              <i class="bi bi-circle"></i><span>Branch</span>
            </a>
          </li>
          <li>
            <a href="actual_fabricators.html">
              <i class="bi bi-circle"></i><span>Fabricators</span>
            </a>
          </li>
          <li>
            <a href="actual_integrators.html">
      ...
      <li class="nav-item">
            ...
            <li>
              <a href="form_emp.html">
              <i class="bi bi-circle"></i><span>Employees</span>
            </a>
          </li>
          <li>
            <a href="form_branch.html">
              <i class="bi bi-circle"></i><span>Branch</span>
            </a>
          </li>
          <li>
            <a href="form_fab.html">
              <i class="bi bi-circle"></i><span>Fabricators</span>
            </a>
          </li>
          <li>
            <a href="form_int.html">
              <i class="bi bi-circle"></i><span>Integrators</span>
            </a>
          </li>
          <li>
