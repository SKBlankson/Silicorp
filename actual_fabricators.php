...
<body>
    <header class="d-flex align-items-center header fixed-top" id="header">
        <div class="d-flex justify-content-between align-items-center"><a class="d-flex align-items-center logo"
                href="dashboard.html"><img src="assets/img/logo.png" alt=""></a><i
                class="bi bi-list toggle-sidebar-btn"></i></div>
        <div class="search-bar">
            <form class="d-flex align-items-center search-form" method="POST" action="#"><input type="text" name="query"
        ...
        <nav class="ms-auto header-nav">
            <ul class="d-flex align-items-center">
                <li class="d-block d-lg-none nav-item"><a class="nav-link nav-icon search-bar-toggle" href="#"><i
                ...
                <li class="nav-item dropdown"><a class="nav-link nav-icon" href="#" data-bs-toggle="dropdown"><i
                            class="bi bi-chat-left-text"></i><span class="badge bg-success badge-number">2</span></a>
                    <ul class="dropdown-menu dropdown-menu-end dropdown-menu-arrow messages">
                        <li class="dropdown-header"> You have 2 new messages <a href="#"><span
                                    class="badge rounded-pill bg-primary p-2 ms-2">View all</span></a></li>
                        <li>
                            <hr class="dropdown-divider">
                        </li>
                        <li class="message-item"><a href="#"><img src="IMG_1487.jpgass=">
                                <div>
                                    <h4>Samuel Blankson</h4>
                                    <p>Don't forget to input those new fabricator partners we just signed with.</p>
                                    <p>4 hrs. ago</p>
                                </div>
                            </a></li>
                        <li>
                        ...
                        <li class="message-item"><a href="#"><img src="IMG_3232.jpIMG_3232.jpgd-circle">
                                <div>
                                    <h4>Edem Afenyo</h4>
                                    <p>How are we coming along with acquiring more semiconductors?</p>
                                    <p>6 hrs. ago</p>
                                </div>
                            </a></li>
                        <li>
                ...
                <li class="nav-item dropdown pe-3"><a class="d-flex align-items-center nav-link nav-profile pe-0"
                        href="#" data-bs-toggle="dropdown"><img class="rounded-circle" src="assets/img/IMG_3222.jpg"
                            alt="Profile"><span class="d-none d-md-block dropdown-toggle ps-2">H. Wood</span></a>
                    <ul class="dropdown-menu dropdown-menu-end dropdown-menu-arrow profile">
                        <li class="dropdown-header">
                            <h6>Henry Wood</h6><span>Administrator</span>
                        </li>
                        <li>
                            <hr class="dropdown-divider">
                        </li>
    ...
    <aside id="sidebar" class="sidebar">
        <ul class="sidebar-nav" id="sidebar-nav">
            ...
            <li class="nav-item"><a class="nav-link collapsed" data-bs-target="#Data_Repository-nav"
                    data-bs-toggle="collapse" href="tables-general.php"><i class="bi bi-card-list"></i><span>Data
                        Repository</span></a>
                <ul id="Data_Repository-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
                    <li><a href="actual_employees.php"><i class="bi bi-circle"></i><span>Employees</span></a></li>
                    <li><a href="actual_branch.php"><i class="bi bi-circle"></i><span>Branch</span></a></li>
                    <li><a href="actual_fabricators.php"><i class="bi bi-circle"></i><span>Fabricators</span></a></li>
                    <li><a href="actual_integrators.php"><i class="bi bi-circle"></i><span>Integrators</span></a></li>
                    <li><a href="actual_storefronts.php"><i class="bi bi-circle"></i><span>Store-front
                                partners</span></a></li>
                </ul>
            </li>
        </ul>
    ...
    <main id="main" class="main">
        <div class="pagetitle">
            ...
            <nav>
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">Fabricators</li>
                </ol>
            </nav>
        </div>
                ...
                <div class="col-lg-12 col-xl-12 col-xxl-12" style="max-width: 100%;">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div style="display: flex;justify-content: space-between;padding-bottom: 15pxs;"><button
                                    class="btn btn-success" type="button" style="margin-right: -1px;">+Add
                                    Record</button><button class="btn btn-primary" type="button" align="right"
                                    style="margin-right: 0px;margin-left: 0px;">Display Graph</button></div>
                            <div>
                                <table class="table table-striped">
                                    <thead>
                                        <tr>
                                            <th scope="col">Fabricator ID</th>
        ...
        $sql = "SELECT Fabricator_ID,Fabricator_name,Location_ID,Email,Telephone FROM Fabricator_Partners LIMIT $offset, $records_per_page";
        $stmt = $pdo->prepare($sql);
        $stmt->execute();
        ...
        foreach ($results as $row) {
            $tableBody .= "<tr>";
            $tableBody .= "<td>" . $row['Fabricator_ID'] . "</td>";
            $tableBody .= "<td>" . $row['Fabricator_name'] . "</td>";
            $tableBody .= "<td>" . $row['Location_ID'] . "</td>";
            $tableBody .= "<td>" . $row['Email'] . "</td>";
            $tableBody .= "<td>" . $row['Telephone'] . "</td>";
            $tableBody .= "<td align='right'><button type='button' class='btn btn-danger' onclick='confirmdelete(this.id)' id='$row[Fabricator_ID]'><i class='bi bi-exclamation-octagon'></i></button>  \
 <button type='button' class='btn btn-info' onclick='showUpdateModal()' id='$row[Fabricator_ID]'><i class='bi bi-info-circle'></i></button></td>";
...
function confirmdelete(buttonId) {
    ...
    <footer id="footer" class="footer">
        <div class="copyright"><span> © Copyright </span><strong><span>NiceAdmin</span></strong><span>. All Rights
                Reserved </span></div>
        <div class="credits"><span> Designed by </span><a href="https://bootstrapmade.com/">BootstrapMade</a></div>
    </footer><a class="d-flex justify-content-center align-items-center back-to-top" href="#"><i
